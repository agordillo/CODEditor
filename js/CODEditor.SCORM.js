...
CODEditor.SCORM = (function(C,$,undefined){
	...
	//Indicates if the Learning Object yields a score
	var hasScore = false;
	...
	var init = function(){
		...
		hasScore = C.ProgressTracking.getHasScore();
		if(hasScore){
	...
	var onProgressObjectiveUpdated = function(objective){
		...
		if(updateScore){
			_updateScore(C.ProgressTracking.getScore());
		}
